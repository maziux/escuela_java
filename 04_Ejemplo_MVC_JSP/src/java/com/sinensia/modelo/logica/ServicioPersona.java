 ...
 * Singleton porque solo queremos un servicio de personas
 * por aplicacion/servidor. 
 */
public class ServicioPersona {

    // <editor-fold defaultstate="collapsed" desc="Código de patrón de diseño Singleton.">
    ...
    public Persona addPersonas(String nombre, String edad)
        ...
        if (nombre.equals("")) {
            ...
            throw new NumberFormatException("La edad está vacia");
        } else {
            int intEdad = Integer.parseInt(edad);
            if (intEdad < 12) {
                throw new NumberFormatException("La edad debe ser mayor que 12");
            } else {
